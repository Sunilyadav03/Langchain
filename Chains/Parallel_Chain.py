...
from langchain.schema.runnable import RunnableParallel    # RunnableParallel is a runnable, with the help of this we can execute multiple chains parallely.

load_dotenv()
 
model1= ChatOpenAI()

model2= ChatAnthropic(model_name= 'claude-3-5-haiku-20241022')
...
prompt2= PromptTemplate(
    template= "Generate 10 short question-answersfrom the following text \n {text}",
    input_variables= ['text']
)
...
text= """
Linear regression is a fundamental statistical method used to model the relationship between a dependent variable and one or more independent variables. It helps predict outcomes by fitting a straight line to observed data points, making it easy to interpret and apply. This article explains the basics of linear regression, its assumptions, and how it works in simple terms. By reading this, you’ll gain a clear understanding of how to use linear regression for predictions, identify trends, and make data-driven decisions. Whether you’re a beginner or looking to refresh your knowledge, this article will provide practical insights and enhance your analytical skills.
...
Linear Regression is a statistical method used to model the relationship between a dependent variable and one or more independent variables by fitting a straight line (linear equation) to the observed data.

Simple Formula (for one variable):
...
m = Slope of the line
b = Y-intercept
It’s used for predicting numerical values, like house prices, sales forecasts, etc.

Also, Read top 7 regression techniques with this article!
...
We need to minimize the cost function J. One of the ways to achieve this is to apply the batch gradient descent algorithm. In batch gradient descent, the values are updated in each iteration. (The last two equations show the updating of values)
